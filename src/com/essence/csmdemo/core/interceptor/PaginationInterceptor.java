...
import com.essence.csmdemo.core.dialect.Dialect;
import com.essence.csmdemo.core.dialect.OracleDialect;
import com.essence.csmdemo.core.dialect.PageContext;
import com.essence.csmdemo.core.dialect.ReflectHelper;
...
public class PaginationInterceptor implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		if (parameterObject != null)
			page = (PageVO) ReflectHelper.isPage(parameterObject, "page");
